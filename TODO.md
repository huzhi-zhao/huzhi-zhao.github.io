...
- [ ] 评审 [ADR-0013 公开仓库的隐私边界](docs/adr/0013-public-repo-privacy-boundary.md)，
      提议中 → 已接受 / 修改
- [ ] 评审 [ADR-0014 docs 承担简历工作的范围](docs/adr/0014-resume-scope-in-docs.md)，
      提议中 → 已接受 / 修改
- [x] 裁决简历下载入口 —— **彻底删除**，FR-10 已实施
- [ ] 裁决 [设计文档 0002 §5](docs/design/0002-privacy-and-resume-workbench.md) 剩下两个未决问题
...
- [ ] **FR-9.5 迁移下面第 2 节的事实不一致项**到 ToucanShelf `Career/Vault/`，仓库只留指针。
...
> ⚠️ 这一节按 FR-9.5 应迁走，仓库里只留指针。迁移前先放这里。
